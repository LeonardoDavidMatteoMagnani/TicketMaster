...
@PageTitle("Signup | TicketMaster")
@AnonymousAllowed
@PermitAll
@Route("signup")
public class SignUpView extends VerticalLayout {

    public SignUpView(ClienteRepository clienteRepository) {
        ...
        Button signupButton = new Button("Signup", event -> {
            ...
            Cliente cliente = new Cliente(email, nome, cognome, password);
            try {
        ...
        RouterLink loginLink = new RouterLink("Hai già un account? Login", LoginView.class);
        container.add(title, nomeField, cognomeField, emailField, passwordField, signupButton, loginLink);
        add(container);
    }
}
