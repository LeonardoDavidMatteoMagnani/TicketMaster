...
@PageTitle("New Operator | TicketMaster")
@AnonymousAllowed
@PermitAll
@Route(value = "new_operator", layout = UserLayout.class)
public class NewOperatoreView extends VerticalLayout {

    public NewOperatoreView(OperatoreRepository operatoreRepository) {
        ...
        H2 title = new H2("Crea Operatore");
        ...
        Button signupButton = new Button("Crea", event -> {
            ...
            Operatore operatore = new Operatore(email, nome, cognome, password);
            try {
                operatoreRepository.create(operatore);
